...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/json5-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6973&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/json5-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `json5` can be installed with:

```
conda install json5
```

It is possible to list all of the versions of `json5` available on your platform with:
